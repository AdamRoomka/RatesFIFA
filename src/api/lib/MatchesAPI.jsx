...
export const saveMatch = (data) =>
  axiosMatches.post("/matches/", JSON.stringify(data));
export const deleteMatches = (matchId) =>
  axiosMatches.delete(`/matches/${matchId}`);
export const endMatchRes = (id, data) =>
  axiosMatches.post(`/matches/${id}`, JSON.stringify(data));
